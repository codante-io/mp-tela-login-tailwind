    ...
    <div className="flex justify-between">
      <section className="p-14">
        ...
        <form className="mt-14 flex flex-col" onSubmit={handleSubmit}>
          ...
          <button
            id="submit-button"
            className="mt-9 w-[355px] rounded-xl bg-eclipse-10 p-2 text-2xl font-bold text-white transition-opacity hover:opacity-90 disabled:cursor-wait disabled:opacity-50"
          >
            Entrar
          </button>
